...
//This site should only do a full searchfor countries outside the US. This variable will be used later.
$isUSRequest = 0;
if($_REQUEST["cb_storecountry"] != "")
{
	if($_REQUEST["cb_storecountry"] == "United States")
		$isUSRequest = 1;
}
else if($detectCountry == "United States")
{
		$isUSRequest = 1;
}
...
if($isUSRequest == 0)
{
	...
	if(trim($_REQUEST['cb_storecountry'])!="")
	{
		...
		//{
			...
			{
				$AndQry.=" and (cb_swh='Yes')";
			}
			
			$FindStoreQry="SELECT cb_maplat, cb_maplong, cb_storename,cb_storeaddress1,cb_storecity,cb_storeprostate,cb_storepost,CountryName as cb_storecountry,cb_storephone,cb_storewebsite,cb_swh 
...
<link href="css/sweetheart.css" rel="stylesheet" type="text/css" />
                      ...
                      <td align="center" valign="top" class="gra_border1"><table width="840" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            <td align="left" valign="top" class="font-12-gra"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                  <td height="50" align="left" valign="middle" class="font-11-liteblu">&nbsp;</td>
                                </tr>
                                <tr>
                                  <td height="50" align="left" valign="middle" class="font-11-liteblu">
								 ...
								 if($_REQUEST["cb_storecountry"] == "")
								 {
                                     ...
                                     <p>&nbsp;</p>
                                     <div class="font-12-gra">
                                       <p> <b>Find a Store Near You</b> <br />
                                         Narrow your search results by selecting a Country, Postal Code, Distance, and Collection from the filters below. </p>
                                     </div>
                                     </div>
                                     <?
									 }
								  ...
								  <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                      <tr>
                                        <td width="205" align="left" valign="middle">
                                          <select name="cb_storecountry" class="text_field3" id="cb_storecountry" onchange="HideShowDistance(this.value);" style="width:160px;">
...
WHERE  
    ...
    Countries.$nameField asc";
                                        ...
                                        <td width="157" align="left" valign="middle" ><span id="postalcode_ID" style="<? echo $STYL; ?>" ><input type="text" id="cb_storepost" name="cb_storepost" class="text_field3" onfocus="SetPostalZip(true);" onblur="SetPostalZip(false);" value="<?=$ZIP;?>" /></span>&nbsp;</td>
                                        <td width="145" align="left" valign="middle" ><span id="distance_ID" style="<? echo $STYL; ?>" ><select  name="distance" class="text_field3" id="distance"><option value="">Distance</option><option value="10" <? if($_REQUEST['distance']==10){echo "selected";}?>>10 Miles</option><option value="20" <? if($_REQUEST['distance']==20){echo "selected";}?>>20 Miles</option><option value="50" <? if($_REQUEST['distance']==50){echo "selected";}?>>50 Miles</option><option value="800000000000" <? if($_REQUEST['distance']==800000000000){echo "selected";}?>>Over 50 Miles</option></select></span>&nbsp;</td>
                                        <td width="40" align="left" valign="middle">&nbsp;</td>
                                        <td width="77" align="right" valign="middle" class="font-12-gra">Collection:</td>
                                        <td align="right" valign="middle" width="175"><select name="collection" class="text_field3" id="collection" style="width:160px;"><option value="">ALL</option><option value="cb_swh" <? if($_REQUEST['collection']=="cb_swh"){echo "selected";}?>>SWEETHEART</option></select></td>
                                        <td width="41" align="right" valign="middle"><input name="Srchbtn" type="image" id="Srchbtn" value="Submit" src="images/search_btn.gif" /></td>
                                      </tr>
                                    </table>
								  </form>
                                                                    <br />
                          ...
                          <tr>
                            <td align="left" valign="top" class="font-12-gra"><table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
							   ...
							   ?>  
                                        <td width="33%" align="left" valign="top" class="font-12-liteblu" ><?=stripslashes($FindStoreQryRow['cb_storename']);?> 
                                        <div id="ad<?= $count; ?>" name="ad<?= $count; ?>">
                                         ...
                                         <?php /*?> DISTANCE <br /><?php */?>
										  ...
										  <? 
										  $COL="";
										  if($FindStoreQryRow['cb_swh']=="Yes"){?>
											  Collections Carried: <br />
											  <? if($FindStoreQryRow['cb_swh']=="Yes"){$COL.= "Sweetheart, ";}?>
											  <? echo substr($COL,0,-2);?>
										  <? } ?>
										</td>
                                        <script type="text/javascript">	
                                ...
                                <? if($isUSRequest == 0) { ?>
                                    ...
                                    <? } else{?>
									<tr><td height="150" valign="middle" align="center" class="font-12-gra">Please contact customer service for the nearest retailer.</td></tr>
                                    <? } ?>
								<? } ?>
                                <tr>
                                  <td align="left" valign="top">&nbsp;</td>
