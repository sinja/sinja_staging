  ...
  if($_POST["imageset"])
  {
	  ...
	  while($obj33=mysql_fetch_object($selres33))
	  {
			...
			$titlefinal=addslashes($_REQUEST[$title]);
	   		$qryy = " update galleryimages set title='".$titlefinal."' where id=".$obj33->id;
 			mysql_query($qryy);
	  }	  
  ...
  <table cellSpacing=0 cellPadding=0 width="100%" border=0>
    <tbody>
      ...
      <table width="100%"  border=0 cellpadding="2" cellspacing="2">
        <tr>
          <TD height="35" class="form111">Manage <?php echo $page_title;?> Images </TD>
        </tr>
        <tr>
	...
	<!-- See index.html -->
		<div>
			<form action="IMGUploads/server/script1.php?pid=<?= $_GET["pid"] ?>" method="post" enctype="multipart/form-data" id="form-demo">
<table width="98%" border="0" align="center" cellpadding="3" cellspacing="3" >
                <tr>
                  <td colspan="2" align="center"><strong>Add images to [
                    <?=getname("gallery",$pid,"title");?>
                    ]</strong></td>
                </tr>
                                <tr>
                  <td colspan="2" align="left"><strong>Required image size: 227x405 px</strong></td>
                </tr>
                <? if($msg){?>
                <tr>
	...
	<ul id="demo-list"></ul>
          ...
          <div style="padding:10px;">
                    <input name="Finish" type="button"  value="Return to list" onClick="javascript:document.location.href='manage_retailers_logos.php'" class="bttn-s"/> <input name="Finish" type="button"  value="Click here when you are done uploading." onClick="javascript:document.location.href=document.location.href" class="bttn-s"/>  </div>
          <?php } ?>
          </td>
        </tr>
        <tr>
				   ...
				   <tr>
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
					  <tr>
						...
						?>
						<td align="right"><a class='a-s' href='#' onClick="javascript:document.location.href='delhpprodimg1.php?<? echo $link;?>';">Delete</a>&nbsp;</td>
					  </tr>
					</table>
					</td>
                  </tr>
