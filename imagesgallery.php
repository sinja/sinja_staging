<?php
  ...
  $pid=$_GET["pid"];
  $title=$_GET["title"];	
  $selsql = " select * from galleryimages where pid=$pid order by displayorder asc" ;
  ...
  <table cellSpacing=0 cellPadding=0 width="100%" border=0>
    <tbody>
      ...
      <table width="100%"  border=0 cellpadding="2" cellspacing="2">
        <tr>
          <TD height="35" class="form111">Manage Gallery Images </TD>
        </tr>
        <tr>
...
<table width="98%" border="0" align="center" cellpadding="3" cellspacing="3" >
	...
	<ul id="demo-list"></ul>
          ...
          <div style="padding:10px;">
                    <input name="Finish" type="button"  value="Return to list" onClick="javascript:document.location.href='manage_gallery.php'" class="bttn-s"/> <input name="Finish" type="button"  value="Click here when you are done uploading." onClick="javascript:document.location.href=document.location.href" class="bttn-s"/>  </div>
          </td>
        </tr>
        <tr>
          <td class="formbg">
            ...
            <table width="100%" align="center" border="0" cellspacing="4" cellpadding="4">
              ...
              <td width="250" valign="top" >
                <table border='1' cellpadding='0' cellspacing='0' class="proimagetable" style="border-color:#999999;">
                  <tr>
                    <td align='center' height="105" width="250"><img src="onlinethumb.php?nm=<? echo "../Gallery/".$obj->pimage ;?>&mwidth=101&mheight=102" /></td>
                  </tr>
                  <tr>
                    <td align='center' height="25" ><input  style="width:240px;" type="text" name="title_<? echo $obj->id; ?>" id="title_<? echo $obj->id; ?>" value="<?=stripslashes($obj->title);?>" /></td>
                  </tr>
				   <tr>
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
					  <tr>
						...
						<td align="right"><a class='a-s' href='#' onClick="javascript:document.location.href='delprodimg.php?<? echo "imgid=".$obj->id."&img=".$obj->pimage."&pid=$pid"; ?>';">Delete</a>&nbsp;</td>
					  </tr>
					</table>
					</td>
                  </tr>
			  ...
			  ?>
			   <tr>
				  <td colspan="4" align="center" height="35" ><input name="imageset" type="submit"  value="Update Images Titles"  class="bttn-s" /></td>
				</tr>
