...
if($_POST['HidSubmit']=='1')
{
	...
	*/
	...
	header("location:career_opportunities.php?msg=1");
	exit;
}
$page_title = ' | '.ucwords(strtolower(strt("Career Opportunities")));
?>
<? include("header.php");?>
<body>
<div id="all">
       ...
       <? include("left.php");?>
            <div id="content">
                <?php breadcrumbs(); ?>
                 <div class="pageTitle">
                        <h2><?php e_upstrt('CAREER OPPORTUNITIES');?> </h2>
                    </div>
              <form name="FrmInquiry" id="FrmInquiry" enctype="multipart/form-data" method="post">
              <input type="hidden" name="reason" value="Job Search" id="reason"/>
              <table width="100%" border="0" cellspacing="0" cellpadding="0" >
                  ...
                  <tr>
                    <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          <td width="100%" height="40" align="left" valign="middle" class="font-16-gra"><?php e_upstrt('INTERESTED IN A CAREER AT '.$SITE_NAME.'?');?>
                           <P class="font-12-gra" style="padding:20px 0 ;">
                   <?php e_strt('Our company is made up of driven team members who share a passion for the fashions that we produce and deliver to customers all over the world. We are constantly seeking bright, talented and motivated people who can innovate and rise above the challenges of our industry to make a difference at our organization. As we are constantly growing and developing new markets, positions often become available in our design, marketing, sales and customer service departments.');?>
                    </P> 
                          </td>
                          <td></td>
                        </tr>
                  ...
                  <tr>
                <td width="15%" align="right" valign="middle" class="font-11-blk"><em>* <?php e_strt('required fields');?></em></td>
                  </tr>
                  <tr>
                    <td align="left" valign="top"><table border="0" cellspacing="0" cellpadding="3">
                        ...
                        <tr>
                           <td width="5" align="right" valign="top" class="font-12-gra">* </td>
                          <td align="left" valign="top" class="font-12-gra">
                          <input name="email" type="text" class="text_field1" id="email" value="<?php e_strt('Email');?>"  onfocus="if(this.value=='<?php e_strt('Email');?>'){this.value='';}" onBlur="if(this.value==''){this.value='<?php e_strt('Email');?>';}" /></td>
                          <td align="right" valign="top" class="font-12-gra">*</td>
                          <td align="left" valign="top" class="font-12-gra">
                          <input name="phone" type="text" class="text_field1" id="phone" value="<?php e_strt('Phone Number');?>" onFocus="if(this.value=='<?php e_strt('Phone Number');?>'){this.value='';}" onBlur="if(this.value==''){this.value='<?php e_strt('Phone Number');?>';}"/></td>
                        </tr>
                        <tr>
                          <td align="right" valign="top" class="font-12-gra">&nbsp;</td>
                          <td align="left" valign="top" class="font-12-gra">
                          <input name="zipcode" type="text" class="text_field1" id="zipcode" value="<?php e_strt('Zip Code');?>" onFocus="if(this.value=='<?php e_strt('Zip Code');?>'){this.value='';}" onBlur="if(this.value==''){this.value='<?php e_strt('Zip Code');?>';}"/></td>
                        <td></td>
                          <td></td>
                        </tr>
                        <tr>
                          <td align="right" valign="top" class="font-12-gra">*</td>
                          <td class="font-12-gra" colspan="3" align="left" valign="top">
                          <textarea name="inquiry" rows="4" class="text_field4" id="inquiry" onFocus="if(this.value=='<?php e_strt('Inquiry');?>'){this.value='';}" onBlur="if(this.value==''){this.value='<?php e_strt('Inquiry');?>';}"><?php e_strt('Inquiry');?></textarea></td>
                        </tr>
                      </table></td>
                  </tr>
