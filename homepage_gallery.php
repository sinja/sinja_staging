...
if ($_POST["chseq"] != "") {
    ...
    $upqry1 = "update galleryimages set displayorder='$newseq' where id='$pid'";
    $upqry2 = "update galleryimages set displayorder='$orgseq' where displayorder='$newseq' and pid='" . $_POST["ProdId"] . "'";
...
if ($_POST["imageset"]) {
    $pid = $_GET["pid"];
    $selsql33 = " select * from galleryimages where pid=$pid order by displayorder";
    ...
    while ($obj33 = mysql_fetch_object($selres33)) {
        ...
        $qryy = " update galleryimages set title='" . $titlefinal . "', open = " . $open . " where id=" . $obj33->id;
        mysql_query($qryy);
    }
...
if ($_POST["video"]) {
    ...
    $selsql33 = " select * from galleryimages where pid=$pid AND pimage='" . $video . "' order by displayorder";
    $selres33 = mysql_query($selsql33);
    ...
    if ($rows == 0) {
        ...
        $que = "insert into galleryimages set `pid`=$pid,`pimage` ='$video',`displayorder`='$totalpics',`title`='video', type='video'";
        $run = mysql_query($que);
    }

    $msg = "Video have been updated successfully";
}

$pid = $_GET["pid"];
$type = $_GET["type"];
$gal = $sindb->get_row("SELECT title FROM gallery WHERE id='" . $pid . "'");
$page_title = $gal['title'];
$title = $_GET["title"];
$selsql = " select * from galleryimages where pid=$pid AND type='" . $type . "' order by displayorder asc";
$selres = mysql_query($selsql);
            ...
            <tr>
                <td>
                            ...
                            <tr>
                                ...
                                <td width="80%" valign="top" align="center">
                                    ...
                                    <table width="100%"  border=0 cellpadding="2" cellspacing="2">
                                        <tr>
                                            <TD height="35" class="form111">Manage <?php echo $page_title; ?> Images And Videos </TD>
                                        </tr>
                                        <tr>
                                            <td class="formbg" valign="top">
                                                <?php if ($type != 'video') { ?>
                                                    <div class="container">
                                                        ...
                                                        <!-- See index.html -->
                                                        <div>
                                                            <form action="IMGUploads/server/script.php?pid=<?= $_GET["pid"] ?>" method="post" enctype="multipart/form-data" id="form-demo">
                                                                <table width="98%" border="0" align="center" cellpadding="3" cellspacing="3" >
                                                                    <tr>
                                                                        <td colspan="2" align="center"><strong>Add images to product [
                                                                                <?= getname("gallery", $pid, "title"); ?>
                                                                                ]</strong></td>
                                                                    </tr>
                                                                    <? if ($msg) { ?>
                                                                        <tr>
                                                    ...
                                                    <div style="padding:10px;">
                                                        <input name="Finish" type="button"  value="Return to list" onClick="javascript:document.location.href='manage_homepage_gallery.php'" class="bttn-s"/> <input name="Finish" type="button"  value="Click here when you are done uploading." onClick="javascript:document.location.href=document.location.href" class="bttn-s"/>  </div>
                                                <?php } ?>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="formbg">
                                                ...
                                                <form name="form2" method="post" id="form2">
                                                    <table width="100%" align="center" border="0" cellspacing="4" cellpadding="4">
                                                        <tr>
                                                            <td colspan="3" align="center" height="35" ><strong>Current <?php echo $type . 's'; ?> in [
                                                                    <?= getname("gallery", $pid, "title"); ?>
                                                                    ]</strong></td>
                                                        </tr>
                                                        <?php if ($type == 'video') { ?>
                                                            <tr>
                                                                <td height="25" align="center" valign="top"><strong><span class="a">*</span> Add Video :&nbsp;</strong>
                                                                    <br/>
                                                                    When coping the embeded code for video website, please choose the following sizes:
                                                                    <br/>
                                                                    <strong>Width: 718</strong>
                                                                    <br/>
                                                                    <strong>Height: 441</strong>
                                                                    <br/>
                                                                    <strong>Please follow these options when you embed a video from Vimeo:</strong>
                                                                    <br/>
                                                                    <img src="../images/videoGuideHome.png" width="408" height="274">
                                                                    <br/>
                                                                    <br/>
                                                                    <br/>
                                                                    Please add the embeded code here:
                                                                    <br/>
                                                                    <textarea class="solidinput" style="width:300px;" id="video" name="video"></textarea>
                                                                </td>
                                                            </tr>
                                                        <?php } ?>
                                                        <?
					...
					<table width='100%' border='1' cellpadding='2' cellspacing='2' bordercolor='#FFD447'>
					  <tr>
						<td align='center' class='yellowbold'>No ";
                                                            echo ($type != 'video') ? "Pictures " : "Videos ";
                                                            echo "Added</td>
					  </tr>
					</table></td></pre>";
                                                        }
                                                        while ($obj = mysql_fetch_object($selres)) {
                                                            ...
                                                            <td width="250" valign="top" >
                                                                <table border='1' cellpadding='0' cellspacing='0' class="proimagetable" style="border-color:#999999;">
                                                                    <tr>
                                                                        <td align='center' height="105" width="250">
                                                                            <?php if ($type != 'video') { ?>
                                                                                <img src="onlinethumb.php?nm=<? echo "../Gallery/" . $obj->pimage; ?>&mwidth=101&mheight=102" />
                                                                            <?php } else { ?>
                                                                                <?php echo $obj->pimage; ?>
                                                                            <?php } ?>
                                                                        </td>
                                                                    ...
                                                                    <tr>
                                                                        <td align='center' height="25" >
                                                                            Please Insert Valid URL Here:
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td align='center' height="25" >
                                                                            <input  style="width:240px;" type="text" name="title_<? echo $obj->id; ?>" id="title_<? echo $obj->id; ?>" value="<?= stripslashes($obj->title); ?>" />
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td align='center' height="25" >
                                                                    ...
                                                                    <tr>
                                                                        <td align='center' height="25" >
                                                                            <input name="open_<? echo $obj->id; ?>" id="open_<? echo $obj->id; ?>" value="1" <? if ($obj->open == 1) echo 'checked=""'; ?> type="checkbox" >
                                                                        </td>
                                                                    </tr>
                                                                        ...
                                                                        <td align='center' height="30px">
                                                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                <tr>
                                                                                    ...
                                                                                    <td align="left">
                                                                                        <select name="<? echo $obj->id; ?>" id="<? echo $obj->id; ?>" onChange="chseqfun(<? echo $obj->id; ?>,<? echo $obj->displayorder; ?>);"><option value="0">Select</option>
                                                                                            <? for ($fc = 1; $fc <= $totpics; $fc++) { ?>
                                                                                                <option value="<? echo $fc; ?>" <?
                                                                                        if ($fc == $obj->displayorder) {
                                                                                            echo "selected";
                                                                                        }
                                                                                                ?>><? echo $fc; ?></option>
                                                                                                    <? } ?>
                                                                                    ...
                                                                                    <?php
                                                                                    if ($type != 'video') {
                                                                                        $link = "imgid=" . $obj->id . "&type=$type&img=" . $obj->pimage . "&pid=$pid";
                                                                                    } else {
                                                                                        $link = "imgid=" . $obj->id . "&type=$type&pid=$pid";
                                                                                    }
                                                                                    ?>
                                                                                    <td align="right"><a class='a-s' href='#' onClick="javascript:document.location.href='delhpprodimg.php?<? echo $link; ?>';">Delete</a>&nbsp;</td>
                                                                                </tr>
                                                                            </table>
                                                                        </td>
                                                                    </tr>
                                                        ...
                                                        <tr>
                                                            <td colspan="4" align="center" height="35" >
                                                                <input name="imageset" type="submit"  value="<?php if ($type != 'video') { ?>Update Images URLs  <?php } else { ?>Update Videos<?php } ?>" class="bttn-s" /></td>
                                                        </tr>
