        ...
        <tr>
          <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td align="left" valign="top">&nbsp;</td> <div style="width:1200px;height:700px"><!--change the width and height value as you want-->
  
  <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="100%" height="100%" id="FlipBookBuilder">
                <param name="movie" value="book2.swf?pageIndex=5" />	<!--You change pageIndex=3 to other page index -->
