...
function add_smiley($content) {
    ...
    $followus = '
        <div class="followus">
            <a target="_blank" class="afb" href="https://www.facebook.com/justinalexanderbride"><span class="fb"></span><span class="arrow"></span></a>
            <a target="_blank" class="apt" href="http://pinterest.com/jabridal"><span class="pt"></span><span class="arrow"></span></a>
            <a target="_blank" class="atw" href="http://twitter.com/ja_bridal"><span class="tw"></span><span class="arrow"></span></a>
            <a target="_blank" class="agp" href="https://plus.google.com/u/0/110848549341144635058"><span class="gp"></span><span class="arrow"></span></a>
        </div>
        <div class="likesend">
            <div id="fb-root"></div>
            ...
            js.src = "//connect.facebook.net/es_LA/all.js#xfbml=1&appId=170606893073034";
            fjs.parentNode.insertBefore(js, fjs);
            }(document, \'script\', \'facebook-jssdk\'));</script>
            <div class="fb-like" data-href="' . GetSiteUrl() . '" data-send="true" data-layout="button_count" data-width="450" data-show-faces="false" data-font="arial"></div>
        </div>
                    ...
                    <article id="comment-<?php comment_ID(); ?>" class="comment">
                        <footer class="comment-meta">
                            <div class="comment-author vcard">
                                ...
                                <time pubdate="" datetime=""><?php echo get_comment_date("D, j/n/y - h"); ?></time>
