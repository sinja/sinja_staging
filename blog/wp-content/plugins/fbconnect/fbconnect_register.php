...
if (!isset($regmodal) || !$regmodal){
	...
	}elseif (!is_user_logged_in() || (isset($force_fbloaddata) && $force_fbloaddata)){
...
echo "<fb:login-button ".$requestperms." onlogin=\"javascript:login_register_facebook();\" ></fb:login-button>\n";
...
<?php if ($fb_form_fields_bool["name"] || $registered) : ?>		
		<tr>
			...
			<td class="fb_formfila"><input class="textform" type="text" name="userappname" id="userappname" value="<?php echo $name;?>"/>	</td>	
		</tr>
<?php endif; ?>
...
<?php if ($fb_form_fields_bool["twitter"] && $registered) : ?>		
		...
		<tr>
			...
			<td class="fb_formfila"> <input class="textform" type="text" name="twitter" id="twitter" value="<?php echo $twitter;?>"/>	</td>	
		</tr>
<?php endif; ?>
