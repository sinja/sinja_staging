...
<?php if ($comments) : ?>
	...
	<?php foreach ($comments as $comment) : ?>
		...
		<li <?php echo $oddcomment; ?>id="comment-<?php comment_ID() ?>">
			<h3 class="fbcomment-entry-title"><a target="_blank" href="<?php echo get_permalink($comment->comment_post_ID) ?>" rel="bookmark" title="Permanent Link to <?php echo $comment->post_title;?>"><?php echo $comment->post_title;?></a></h3>
