						...
						$fb_user = fb_get_loggedin_user();
	     				...
	     				<table class="form-table" cellspacing="2" cellpadding="5" width="100%">
							...
							<td>
								...
								<option value="" <?php if( get_option('fb_fbcomments_color')=="") echo 'selected="selected"'; ?>>Light</option>
								<option value="dark" <?php if( get_option('fb_fbcomments_color')=='dark') echo 'selected="selected"'; ?>>Dark</option>
								</select>
							...
							<td>
								...
								<option value="xid" <?php if( get_option('fb_fbcomments_usexid')=="" || get_option('fb_fbcomments_usexid')=="xid") echo 'selected="selected"'; ?>>Use Wordpress postID as facebook comments XID</option>
								<option value="href" <?php if( get_option('fb_fbcomments_usexid')=='href') echo 'selected="selected"'; ?>>Use post URL as href for facebook comments</option>
								</select>
