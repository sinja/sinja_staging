...
= 2.4.11 = 
* Updated: minor updates to admin styling

= 2.4.10 = 
* Updated: button select list for Chrome
* Updated: fix bug with facebook URL error

= 2.4.9 = 
* Updated: pinterest preview style button

= 2.4.8 = 
* Updated: pinterest button css

= 2.4.7 = 
* Updated: use wp_enqueue_script for admin jquery ui
