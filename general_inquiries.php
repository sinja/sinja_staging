...
$page_title = ' | '.ucwords(strtolower(strt("General Inquiries")));
?>
<? include("header.php");?>
<body>
<div id="all">
       ...
       <? include("left.php");?>
            ...
            <?php breadcrumbs(); ?>
                 <div class="pageTitle" style="width:780px;">
                    <h2><?php e_upstrt('General Inquiries');?></h2>
                </div>
               <div id="gi_container">
              ...
              <table  width="50%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          <td width="85%" height="40" align="left" valign="middle" class="font-16-gra" style="padding-left:5px;">
                          <?php e_upstrt('Have a question about '.$SITE_NAME.'?');?></td>
                        
                        </tr>
                        <tr>
                          <td width="15%" align="right" valign="middle" class="font-11-blk" style="padding-bottom:5px;"">
                          <em class="italic">* <?php e_strt('required fields');?></em></td>
                        </tr>
                      </table></td>
                  </tr>
                  ...
                  <tr>
                    <td align="left" valign="top"><table border="0" cellspacing="0" cellpadding="3">
                        <tr>
                          ...
                          <td width="5" align="right" valign="top" class="font-12-gra">* </td>
                          <td align="left" valign="top" class="font-12-gra"><select name="reason" class="text_field1" id="reason"><option value=""><?php e_strt("Reason for interest");?></option><?=GetDropdown(name,name,reasonforinterest,' order by id asc',"");?></select></td>
                        </tr>
                        <tr>
                          <td align="right" valign="top" class="font-12-gra">*</td>
                          <td align="left" valign="top" class="font-12-gra">
                           <input name="email" type="text" class="text_field1" id="email" value="<?php e_strt('Email');?>"  onfocus="if(this.value=='<?php e_strt('Email');?>'){this.value='';}" onBlur="if(this.value==''){this.value='<?php e_strt('Email');?>';}" />
                          </td>
                           <td width="5" align="right" valign="top" class="font-12-gra">* </td>
                          <td align="left" valign="top" class="font-12-gra">
                          <select name="region" class="text_field1" id="region">
                        ...
                        <tr>
                          <td align="right" valign="top" class="font-12-gra">*</td>
                          <td align="left" valign="top" class="font-12-gra">
                         <input name="phone" type="text" class="text_field1" id="phone" value="<?php e_strt('Phone Number');?>" onFocus="if(this.value=='<?php e_strt('Phone Number');?>'){this.value='';}" onBlur="if(this.value==''){this.value='<?php e_strt('Phone Number');?>';}"/>
                          </td>
                          <td align="right" valign="top" class="font-12-gra">&nbsp;</td>
                          <td align="left" valign="top" class="font-12-gra">
                          <input name="zipcode" type="text" class="text_field1" id="zipcode" value="<?php e_strt('Zip Code');?>" onFocus="if(this.value=='<?php e_strt('Zip Code');?>'){this.value='';}" onBlur="if(this.value==''){this.value='<?php e_strt('Zip Code');?>';}"/>
                          </td>
                        </tr>
                        <tr>
                          <td align="right" valign="top" class="font-12-gra">*</td>
                          <td class="font-12-gra" colspan="3" align="left" valign="top">
                          <textarea name="inquiry" rows="4" class="text_field4" id="inquiry" onFocus="if(this.value=='<?php e_strt('Inquiry');?>'){this.value='';}" onBlur="if(this.value==''){this.value='<?php e_strt('Inquiry');?>';}"><?php e_strt('Inquiry');?></textarea>
                          </td>
                        </tr>
                      </table></td>
                  </tr>
                  <tr class="bottom-submit">
                    <td height="25" align="left" valign="middle" class="font-11-blk"><em class="italic">
                    <?php e_strt('If you are inquiring about location based information at the mimimum please supply us with your zip/postal code');?>.</em></td>
                  </tr>
                  <tr class="bottom-submit">
